...
def main():
    ...
    args.discriminator_iter_start=10000
    ...
    # args.default_root_dir='/cluster/project7/IPFMortalityPredictionNewloss/TATS-main/'
    args.default_root_dir='/cluster/project7/IPFMortalityPredictionNewloss/TATS-main/experiment19/'
    ...
    callbacks.append(ModelCheckpoint(every_n_train_steps=2000, save_top_k=-1, filename='{epoch}-{step}-{train/recon_loss:.2f}'))
    ...
    trainer = pl.Trainer.from_argparse_args(args, callbacks=callbacks,
                                            max_steps=args.max_steps, precision=16, **kwargs)
