...
class VidODE(nn.Module):
    ...
    def build_model(self):
        ...
        if not self.args.classification :
            ...
            self.decoder = Decoder(input_dim=base_dim, output_dim=self.args.vocab_size, n_ups=self.args.n_downs).to(self.device)
    ...
    def get_reconstruction(self, time_steps_to_predict, truth, truth_time_steps, mask=None, out_mask=None):
        ...
        del pred_x_all,sol_y_all
        if round(torch.cuda.memory_reserved(0)/1024**3,1)>64:
